...
class SwipeConfiguration {
  ...
  double verticalSwipeMinDisplacement = 25.0;
  double verticalSwipeMinVelocity = 25.0;

  //Horizontal swipe configuration options
  double horizontalSwipeMaxHeightThreshold = 100.0;
  double horizontalSwipeMinDisplacement = 25.0;
  double horizontalSwipeMinVelocity = 25.0;
